...
- [Configuration and usage reference](configuration.md)
- [Checks](checks.md)
...
- [Supported verification subset](supported-verification-subset.md)
- [False-safe response policy](false-safe-response.md)

# Safety & certification support

- [DO-178C verification-support profiles](do178c-profiles.md)
...
- [Benchmarks & quality evidence](evidence.md)
