...
| `Identical_Case_Alternative` | `defect` | Reports adjacent case alternatives (in case statements or case expressions) with identical bodies. | `gnatcheck-comparison` | `tests/precision_identical_case_alternative_adjacent_finding.adb` | `tests/precision_identical_case_alternative_nonadjacent_clean.adb` |
