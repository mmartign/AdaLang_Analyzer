...
This is a **documentation-based** comparison: AdaLang Analyzer's 99 checks
...
Of AdaLang Analyzer's 99 checks:
...
| No GNATcheck counterpart | 49 | Nothing in the predefined catalog does this |
...
49 of AdaLang's 99 rules do something GNATcheck's predefined catalog does
...
No_Label, Unused_Parameter, Wrong_Parameter_Mode, Shadowed_Declaration,
