...
| Compliance reporting | `--compliance-report=do178c` generates a Markdown, per-objective evidence report. Markdown only; a machine-readable (JSON/SARIF) form remains open. | Add a structured export format for tooling that consumes the report programmatically. |
