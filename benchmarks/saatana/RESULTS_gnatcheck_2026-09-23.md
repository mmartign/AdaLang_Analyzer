...
| --- | ---: | ---: |
| AdaLang findings | 204 | 157 |
| &nbsp;&nbsp;matched by GNATcheck | 134 (65.7%) | 96 (61.1%) |
| GNATcheck findings | 167 | 129 |
| &nbsp;&nbsp;matched by AdaLang | 134 (80.2%) | 96 (74.4%) |
...
AdaLang's side of it is identical to that run's (157 findings): none of
...
| No_Pragma | `forbidden_pragmas` | close | 40 | 7 | 33 | 0 |
| Duplicate_With_Clause | `warnings:r.with` | direct | 0 | 0 | 0 | 0 |
| Long_Line | `style_checks:M` | direct | 6 | 1 | 5 | 0 |
