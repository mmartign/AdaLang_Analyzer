...
# reports per-bucket agreement counts. See benchmarks/saatana/README.md
# for the matching design and its caveats. Identical to
# benchmarks/sparknacl/compare.awk and benchmarks/cubedos/compare.awk;
...
END {
   ...
   print "CubedOS / GNATprove agreement report"
   print "====================================="
   print ""
