...
| --- | ---: | ---: |
| AdaLang findings | 2096 | 1847 |
| &nbsp;&nbsp;matched by GNATcheck | 1261 (60.2%) | 1046 (56.6%) |
| GNATcheck findings | 2933 | 2665 |
| &nbsp;&nbsp;matched by AdaLang | 1259 (42.9%) | 1044 (39.2%) |
...
AdaLang's side of it is identical to that run's (1847 findings): none of
this refresh's fixes changed a check that was already paired.
GNATcheck's side is 2665 against 2523 then; every run here was
...
| No_Pragma | `forbidden_pragmas` | close | 215 | 0 | 267 | 52 |
...
| Unused_With_Clause | `warnings:u.unit` | close | 2 | 2 | 1 | 1 |
| Unused_Variable | `warnings:u.object` | close | 3 | 3 | 0 | 0 |
| Unused_Parameter | `warnings:f` | close | 13 | 13 | 0 | 0 |
| Wrong_Parameter_Mode | `warnings:k.mode` | close | 4 | 4 | 0 | 0 |
| Overwritten_Assignment | `warnings:m.overwritten` | close | 2 | 2 | 0 | 0 |
| Dead_Store | `warnings:m.never` | close | 9 | 9 | 0 | 0 |
