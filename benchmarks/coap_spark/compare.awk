...
# reports per-bucket agreement counts. See benchmarks/coap_spark/README.md
# for the matching design and its caveats. Identical to
# benchmarks/sparknacl/compare.awk, benchmarks/saatana/compare.awk,
# benchmarks/cubedos/compare.awk, and benchmarks/libkeccak/compare.awk;
# kept as a separate copy so each benchmark directory is self-contained and
...
END {
   ...
   print "coap_spark / GNATprove agreement report"
   print "========================================"
   print ""
