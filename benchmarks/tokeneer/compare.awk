...
# reports per-bucket agreement counts. See benchmarks/tokeneer/README.md
# for the matching design and its caveats. Identical to
# benchmarks/sparknacl/compare.awk, benchmarks/saatana/compare.awk,
# benchmarks/libkeccak/compare.awk, and benchmarks/cubedos/compare.awk;
# kept as a separate copy so each benchmark directory is self-contained
...
END {
   ...
   print "Tokeneer / GNATprove agreement report"
   print "======================================"
   print ""
