...
| --- | ---: | ---: |
| AdaLang findings | 860 | 807 |
| &nbsp;&nbsp;matched by GNATcheck | 378 (44.0%) | 378 (46.8%) |
| GNATcheck findings | 1087 | 1087 |
| &nbsp;&nbsp;matched by AdaLang | 378 (34.8%) | 378 (34.8%) |
...
AdaLang's side of it is identical to that run's (807 findings): none of
...
| No_Pragma | `forbidden_pragmas` | close | 44 | 44 | 0 | 0 |
...
| Unused_With_Clause | `warnings:u.unit` | close | 2 | 2 | 0 | 0 |
| Unused_Variable | `warnings:u.object` | close | 2 | 2 | 0 | 0 |
| Unused_Parameter | `warnings:f` | close | 0 | 0 | 0 | 0 |
| Wrong_Parameter_Mode | `warnings:k.mode` | close | 5 | 5 | 0 | 0 |
