...
# reports per-bucket agreement counts. See benchmarks/libkeccak/README.md
# for the matching design and its caveats. Identical to
# benchmarks/sparknacl/compare.awk, benchmarks/saatana/compare.awk, and
# benchmarks/cubedos/compare.awk; kept as a separate copy so each
# benchmark directory is self-contained and independently runnable.
...
END {
   ...
   print "Libkeccak / GNATprove agreement report"
   print "========================================"
   print ""
