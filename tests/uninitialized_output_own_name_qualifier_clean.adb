procedure Uninitialized_Output_Own_Name_Qualifier_Clean is
   ...
   protected body Waiter_Information is
      ...
      --  name ("Info") to qualify its own out parameters, disambiguating
      --  them from the protected object's same-named private components
      --  (Ada's general unit-name qualification, RM 8.3) -- not a field
...
begin
   null;
end Uninitialized_Output_Own_Name_Qualifier_Clean;
